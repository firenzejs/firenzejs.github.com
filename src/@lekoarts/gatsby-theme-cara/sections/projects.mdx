...
<ProjectCard title="17 Nov 2021" link="#" bg={"linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"}>
  <h5>Event-driven architectures with Serverless</h5>
  <i>di Mattia Lobertini</i>
</ProjectCard>

<ProjectCard title="15 Dic 2021" link="#" bg={"linear-gradient(to right, #009245 0%, #FCEE21 100%)"}>
  <h5>Un introduzione a Tailwind.css</h5>
  <i>di Andrea Bacci</i>
</ProjectCard>
